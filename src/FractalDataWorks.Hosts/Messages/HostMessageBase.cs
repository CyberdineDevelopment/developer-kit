...
/// </summary>
[EnhancedEnumOption("HostMessages")]
public abstract class HostMessageBase : MessageBase
{
    /// <summary>
    ...
    protected HostMessageBase(string code, string message, MessageSeverity severity = MessageSeverity.Information)
